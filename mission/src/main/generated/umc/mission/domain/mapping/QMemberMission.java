...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = 77331213L;
    ...
    public final umc.mission.domain.QMember member;

    public final umc.mission.domain.QMission mission;

    public final EnumPath<umc.mission.domain.enums.MissionStatus> status = createEnum("status", umc.mission.domain.enums.MissionStatus.class);
    ...
    public QMemberMission(Class<? extends MemberMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new umc.mission.domain.QMember(forProperty("member")) : null;
        this.mission = inits.isInitialized("mission") ? new umc.mission.domain.QMission(forProperty("mission"), inits.get("mission")) : null;
    }
